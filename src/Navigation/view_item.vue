   ...
   <b-card-group> 
    <!-- card one -->
     <b-card class="site-categories"
       ...
       img-src="https://res.cloudinary.com/drsayrtmp/image/upload/c_scale,h_300,w_400/v1554186893/Spare-parts-fridge-3__281_29.jpg" 
    ...
    <!-- card one -->
     ...
     img-src="https://res.cloudinary.com/drsayrtmp/image/upload/c_thumb,h_300,w_400/v1554186746/LG_G4-2.jpg" 
     img-alt="Image" img-top>
     <b-card-text>
        View all the parts you have posted, modify posts... 
     </b-card-text>
    ...
    <b-card class="site-categories" 
    title="Entertainment" 
    img-src="https://res.cloudinary.com/drsayrtmp/image/upload/c_scale,h_300,w_400/v1554187811/SONIQ_-_TV_1.jpg" 
    img-alt="Image" img-top>
       <b-card-text>
        View all the parts you have posted, modify posts... 
       </b-card-text>
